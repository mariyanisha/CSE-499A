...
<html lang="en">
  ...
  $(document).ready(function(){
  $("#U1").click(function(){
  alert("plugin to University of Barminghum.UK!!!!!")
  });
  });
  </script>
  <script>
  $(document).ready(function(){
  $("#U2").click(function(){
  alert("plugin to University of Bath.UK!!!!!")
  });
  });
  </script>
  <script>
  $(document).ready(function(){
  $("#U3").click(function(){
  alert("plugin to University of London.UK!!!!!")
  });
  });
  </script>
  <script>
  ...
  <body>
    <div class="container-fluid" style="background-color: #FFFFFF; position: -webkit-sticky;
      ...
      <nav class="navbar navbar-expand-sm " style="background-color:#FFFFFF;">
        <ul class="navbar-nav" style="background-color: #FFFFFF;" >
          <li class="nav-item" >
            <a href="index.php"><img src="img/logo.png" alt="" style="max-height: 50px;width:80px;margin-left: 10px;margin-top:10px; "></a>
          </li>
          <li class="nav-item">
            <a class="nav-link " id="X" href="#" onclick="showDiv()"><img src="img/2n.png" alt="" style="max-height: 40px;width:107px;margin-left: 10px; ">
            </a>
            
          </li>
          
          <li class="nav-item">
            <a class="nav-link " id="Y" href="#" onclick="showDiv()"><img src="img/3n.png" alt="" style="max-height: 40px;width:100px; margin-left: 10px;"></a>
            
          </li>
          <li class="nav-item">
            <a class="nav-link" id="Z" href="#"><img src="img/4n.png" alt="" style="max-height: 40px;width:105px;margin-left: 10px; ">
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#" id="W"><img src="img/5n.png" alt="" style="max-height: 40px;width:51px;margin-left: 640px; ">
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#" id="C"><img src="img/6n.png" alt="" style="max-height: 40px;width:51px;margin-left: 1px; ">
            </a>
          </li>
        </ul>
      </nav>
    ...
    <div class="container">
      ...
      <div class="row" style="text-align: center;">
        <div class="col-sm-2 A" style="border: solid #FFFFFF;padding: 38px 0px 25px;">
          ...
          <a href="AgForest.php" style="color: black; text-decoration: none;"><p>Agriculture & Forestry</p></a>
        </div>
        <div class="col-sm-2 A" style="border: solid #FFFFFF;padding: 38px 0px 25px;">
          <i class="fa fa-flask" style="font-size:45px;"></i>
          <a href="AppliedScience.php" style="color: black; text-decoration: none;"><p>Applied Science & professions</p></a>
        </div>
        <div class="col-sm-2 A" style="border: solid #FFFFFF;padding: 38px 0px 25px;">
          <i class="fa fa-briefcase" style="font-size:45px;"></i>
          <a href="BS.php" style="color: black; text-decoration: none;"><p>Business & Management</p></a>
        </div>
        <div class="col-sm-2 A" style="border: solid #FFFFFF;padding: 38px 0px 25px;">
          <i class="fa fa-laptop" style="font-size:45px;"></i>
          <a href="AgForest.php" style="color: black; text-decoration: none;"><p>Computer Science & IT</p></a>
        </div>
        <div class="col-sm-2 A" style="border: solid #FFFFFF;padding: 38px 0px 25px;">
          <i class="fa fa-book" style="font-size:45px;"></i>
          <a href="AgForest.php" style="color: black; text-decoration: none;"><p>Education & Training</p></a>
        </div>
        <div class="col-sm-2 A" style="border: solid #FFFFFF;padding: 38px 0px 25px;">
          <i class="fa fa-cogs" style="font-size:45px;"></i>
          <a href="AgForest.php" style="color: black; text-decoration: none;"><p>Engineering & Techbology</p></a>
        </div>
      </div>
      <div class="row" style="text-align: center;">
        <div class="col-sm-2 A" style="border: solid #FFFFFF;padding: 38px 0px 25px;">
          <i class="fa fa-globe" style="font-size:45px; "></i>
          <a href="AgForest.php" style="color: black; text-decoration: none;"><p>Environment Studies & Earth Science</p></a>
        </div>
        <div class="col-sm-2 A" style="border: solid #FFFFFF;padding: 38px 0px 25px;">
          <i class="fa fa-video-camera" style="font-size:45px;"></i>
          <a href="AgForest.php" style="color: black; text-decoration: none;"><p>Journalism & Media</p></a>
        </div>
        <div class="col-sm-2 A" style="border: solid #FFFFFF;padding: 38px 0px 25px;">
          <i class="fa fa-balance-scale" style="font-size:45px;"></i>
          <a href="AgForest.php" style="color: black; text-decoration: none;"><p>Law</p></a>
        </div>
        <div class="col-sm-2 A" style="border: solid #FFFFFF;padding: 38px 0px 25px;">
          <i class="fa fa-medkit" style="font-size:45px;"></i>
          <a href="AgForest.php" style="color: black; text-decoration: none;"><p>Medicine & Health</p></a>
        </div>
        <div class="col-sm-2 A" style="border: solid #FFFFFF;padding: 38px 0px 25px;">
          <i class="fa fa-flask" style="font-size:45px;"></i>
          <a href="AgForest.php" style="color: black; text-decoration: none;"><p>natural Sciences & Mathmatics</p></a>
        </div>
        <div class="col-sm-2 A" style="border: solid #FFFFFF;padding: 38px 0px 25px;">
          <i class="fa fa-bullhorn" style="font-size:45px;"></i>
          <a href="AgForest.php" style="color: black; text-decoration: none;"><p>Social Sciences</p></a>
        </div>
      </div>
      <div class="row" style="">
      ...
      <div class="row" style="">
        <div class="col-sm-12 " style="text-align: center; margin: 12px auto 41px;">
          ...
          <a href="Allcountry.php" style="color: #1E8558;">View all countries</a>
        </div>
    ...
    <div class="container-fluid" style="background-color:#EDF3F6; ">
      <div class="row" style="margin: 35px 100px 0px;
        ...
        <div class="col-sm-4">
          ...
          <a id="U1" href="https://www.birmingham.ac.uk/personal-page/index.aspx"><img src="img/18.png" style="width: 100%;height: 100%;"></a>
        </div>
        <div class="col-sm-4">
          <a id="U2" href="https://www.bath.ac.uk/"><img src="img/19.png" style="width: 100%;height: 100%;"></a>
        </div>
        <div class="col-sm-4">
          <a id="U3" href="https://london.ac.uk/"><img src="img/20.png" style="width: 100%;height: 100%;"></a>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-6">
          <a href="A1.php" style="color: black;"><h5>The Stress-Free Way of Getting Great Accommodation as an International Student</h5></a>
          <p>Find the best student accommodation while getting your degree abroad. Discover how Uniplaces can help you!</p>
        </div>
        <div class="col-sm-6">
          <a href="A2.php" style="color: black;"><h5>How Student Reviews Can Help You Find the Best University for You in 2021 </h5></a>
        ...
        <div class="col-sm-6">
          <a href="A3.php"  style="color: black;"><h5>What Can I Do with a Master’s in Marketing?</h5></a>
        ...
        <div class="col-sm-6">
          <a href="A4.php"  style="color: black;"><h5>Top 5 Reasons to Study a Master's in Medicine</h5></a>
      ...
      <div class="row" style="">
        <div class="col-sm-12 " style="text-align: right; margin: 12px auto 41px;">
          ...
          <a href="Morearticle.php" style="color: #1E8558;">More Articles</a>
        </div>
        
      </div>
    </div>
    <div class="container-fluid" style="background-image: url('img/26.png') ;padding: 52px 111px 80px;">
      <div class="row">
