      ...
      <div class="container-fluid"  >
        <div class="row">
          <div class="col-sm-12" style="margin-top: 200px;margin-bottom: 50px;">
            <h1 style="color: #FFFFFF;font-size: 65px;"><i class="fa fa-tree" style="font-size: 148px;
            color: black;"></i></h1>
            
            <p style="color: black;font-size: 40px;">Masters in Agriculture & Forestry</p>
          </div>
    ...
    <div class="jumbotron text-center">
      ...
      <div class="container">
        <div class="row" style="text-align: left;">
          <h3>Best Universities for Agriculture & Forestry on MastersPortal</h3>
          <div class="col-sm-5" >
            <h3>Universities</h3>
