...
<div class="form-group">
      ...
      <input type="email" class="form-control" id="email" placeholder="University Location"  name="email">
    </div>
    <div class="Z">
      <form action="">
  <label for="cars">Offered_Programes :</label>
  <select name="cars" id="cars">
    <option value="volvo">Masters</option>
    <option value="saab">Graduation</option>
    <option value="opel">B.Sc</option>
    <option value="audi">B.Com</option>
  ...
  <br><br>
    ...
    <button type="button" class="btn btn-success">Add University</button>
  </form>
</div>
